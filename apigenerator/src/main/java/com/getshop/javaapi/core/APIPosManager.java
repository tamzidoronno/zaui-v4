...
public class APIPosManager {
     ...
     * @author ktonder
     */
     public void addGiftCardToTab(Object tabId, Object value)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("tabId",new Gson().toJson(tabId));
          gs_json_object_data.args.put("value",new Gson().toJson(value));
          gs_json_object_data.method = "addGiftCardToTab";
          gs_json_object_data.interfaceName = "core.pos.IPosManager";
          String result = transport.send(gs_json_object_data);
     }
     ...
     * @author ktonder
     */
     public JsonElement getConferencesThatHasUnsettledAmount(Object userIds)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("userIds",new Gson().toJson(userIds));
          gs_json_object_data.method = "getConferencesThatHasUnsettledAmount";
          gs_json_object_data.interfaceName = "core.pos.IPosManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          JsonElement object = gson.fromJson(result, JsonElement.class);
     ...
     * @author ktonder
     */
     public JsonElement hasConferences()  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.method = "hasConferences";
          gs_json_object_data.interfaceName = "core.pos.IPosManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          JsonElement object = gson.fromJson(result, JsonElement.class);
