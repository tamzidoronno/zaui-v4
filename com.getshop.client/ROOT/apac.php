<?
include '../loader.php';
$pageFactory = new \PageFactory("apac");
...
if(!$factory->getApi()->getUserManager()->isLoggedIn() || !ns_df435931_9364_4b6a_b4b2_951c90cc0d70\Login::getUserObject()) {
    setcookie('PHPSESSID','');
    header('location:/login.php?redirectto=/apac.php');
    exit(0);
}
...
?>
<html pageid="<? echo $page->getId(); ?>" module="apac">
    <head>
    ...
    <body>
        ...
        <div class="gs_body" hasleftmenu="<? echo $page->getLeftMenu() ? 'yes' : 'no'; ?>">
            <?
            if ($page->getLeftMenu()) { $page->getLeftMenu()->renderLeft("apac"); }
            ?>
