    ...
    <body editormode="<? echo $factory->isEditorMode() ? "true" : "false"?>">
        ...
        <? if ($factory->isEditorMode() && !$factory->isMobile()) {
            echo "<div class='gs_site_main_buttons_view'>";
                ...
                echo "<div title='".$factory->__f("Drag to location where you want to add content")."' class='gs_site_main_button'><i class='fa fa-plus-circle gsaddrowcontentdnd'></i></div>";
                echo "<div title='".$factory->__f("Drag to location where you want to add content")."' class='gs_site_main_button'><i class='fa fa-plus-circle gsaddcolumncontentdnd'></i></div>";
