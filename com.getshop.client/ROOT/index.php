...
<body editormode="<? echo $factory->isEditorMode() ? "true" : "false" ?>">
    ...
    ?>
    <div class='gsrightwidgetpanel' style='<? echo $showRightPanel; ?>'>
        <div class='gsrightwidgetpanelheader'><i class='fa fa-close' onclick='thundashop.framework.toggleRightWidgetPanel();'></i></div>
