    ...
    <body editormode="<? echo $factory->isEditorMode() ? "true" : "false"?>">
        ...
        <? if ($factory->isEditorMode() && !$factory->isMobile()) {
            echo "<div class='gs_site_main_buttons_view'>";
                ...
                echo "<div title='".$factory->__f("Create a new row")."' class='gs_site_main_button'><i class='fa fa-minus gsaddrowcontentdnd'></i></div>";
                echo "<div title='".$factory->__f("Create a new column")."' class='gs_site_main_button'><i class='fa fa-columns gsaddcolumncontentdnd'></i></div>";
