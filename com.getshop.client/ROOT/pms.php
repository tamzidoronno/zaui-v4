...
<html pageid="<? echo $page->getId(); ?>" module="pms">
    ...
    <?php
     ...
     echo "<div style='text-align:center;padding: 5px; background-color:red; color:#fff; font-size: 20px;       '><i class='fa fa-warning'></i> Instructions on how to change the tax from 12% to 6% for a tempora$
