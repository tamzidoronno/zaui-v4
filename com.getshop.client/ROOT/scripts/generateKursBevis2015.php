...
$content .= "<head>
    <style>
        ...
        .title2 { text-align:center; font-weight:bold; width: 100%; font-size: 35px; margin-bottom: 60px; margin-top: 80px; }
        .heading { margin-top: 30px; }
        .body { margin-top: 20px;  }
        .name { font-size: 23px; text-transform:uppercase; }
        .company { font-size: 23px; text-transform:uppercase; }
        .footer { width: 100%; color:#000000; text-align: center;  position: fixed; bottom: 200px; left: 0px; right: 0px;}
