...
foreach ($routes as $route) {
    ...
    $stdClass->completedTime = date('m/d/Y h:m', strtotime($route->completedInfo->completedTimeStamp));
    $stdClass->startedTime = date('m/d/Y h:m', strtotime($route->startInfo->startedTimeStamp));
    $stdClass->deliveryServiceDate = date('m/d/Y h:m', strtotime($route->deliveryServiceDate));;
    $retRoutes[] = $stdClass;
}
