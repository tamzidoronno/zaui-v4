...
getshop.MenuEditor = {
    init: function() {
        ...
        $(document).on('click touchend', ".Menu .mobilenavigatemenu", getshop.MenuEditor.showMenu);
        $(document).on('click touchend', ".Menu .cancel", getshop.MenuEditor.closeMenuEditor);
