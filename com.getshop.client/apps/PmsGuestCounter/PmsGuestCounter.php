...
class PmsGuestCounter extends \WebshopApplication implements \Application {
    ...
    public function getContent() {
        ...
        echo "<center>";
        echo "<h3>Since august 2016 <b style='color:#98048c; font-size: 32px;padding: 10px;'>" . $content['results'][0]['series'][0]['values'][0][1] . "</b> guests have automatically been granted access to their hotel room by me. -KaiPal</h3>";
        echo "</center>";
    }
}
?>
