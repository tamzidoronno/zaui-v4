...
class APICalendarManager {
	...
	*/
	...
	public function getDetailedStatistic($from, $to) {
	     $data = array();
	     $data['args'] = array();
	     ...
	     $data["method"] = "getDetailedStatistic";
	     $data["interfaceName"] = "core.calendar.ICalendarManager";
	     return $this->transport->sendMessage($data);
	}
...
class APIOrderManager {
	...
	*/
	...
	public function checkForRecurringPayments() {
	     $data = array();
	     $data['args'] = array();
	...
	*/
	...
	public function setExpiryDate($orderId, $date) {
	     $data = array();
	     $data['args'] = array();
	     $data['args']["orderId"] = json_encode($this->transport->object_unset_nulls($orderId));
	     $data['args']["date"] = json_encode($this->transport->object_unset_nulls($date));
...
class APISedoxProductManager {
	...
	*/
	...
	public function getSedoxProductByMd5Sum($md5sum) {
	     ...
	     $data["interfaceName"] = "core.sedox.ISedoxProductManager";
	     return $this->transport->cast(new core_sedox_SedoxSharedProduct(), $this->transport->sendMessage($data));
	}
	...
	*/
	...
	public function getSharedProductById($id) {
	     ...
	     $data['args'] = array();
	     $data['args']["id"] = json_encode($this->transport->object_unset_nulls($id));
	     $data["method"] = "getSharedProductById";
	     $data["interfaceName"] = "core.sedox.ISedoxProductManager";
	     return $this->transport->cast(new core_sedox_SedoxSharedProduct(), $this->transport->sendMessage($data));
	}
	...
	*/
	...
	public function toggleBadCustomer($userId, $badCustomer) {
	     ...
	     $data['args'] = array();
	     $data['args']["userId"] = json_encode($this->transport->object_unset_nulls($userId));
	     $data['args']["badCustomer"] = json_encode($this->transport->object_unset_nulls($badCustomer));
...
class APIUserManager {
	...
	*/
	...
	public function createSubAccount($fullName, $phoneNumber) {
	     $data = array();
	     $data['args'] = array();
	...
	*/
	...
	public function mergeUsers($userId, $userIds) {
	     $data = array();
	     $data['args'] = array();
	     $data['args']["userId"] = json_encode($this->transport->object_unset_nulls($userId));
	     $data['args']["userIds"] = json_encode($this->transport->object_unset_nulls($userIds));
	     $data["method"] = "mergeUsers";
	     $data["interfaceName"] = "core.usermanager.IUserManager";
	     return $this->transport->sendMessage($data);
	}
