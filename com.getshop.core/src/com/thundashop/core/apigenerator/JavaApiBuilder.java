...
public class JavaApiBuilder {
    ...
    private String buildJavaApiContent(HashMap<String, String> args, String methodName, String interfaceName, String returnClass) {
        String content = "";
            ...
            for (Annotation annotation : annotations) {
                if (annotation instanceof GetShopApi) {
                    ...
                    for (ApiMethod method : methods) {
                        ...
                        content += buildJavaApiContent(method.arguments, method.method.getName(), ifacename, returnvalue);
                        content += "     }\r\n\r\n";
                    }
                    content += "}\r\n";
                }
