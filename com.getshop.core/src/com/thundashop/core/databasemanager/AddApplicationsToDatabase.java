...
public class AddApplicationsToDatabase {
    ...
    private List<ApplicationSettings> addApplications() {
        ...
        apps.add(createSettings(
                ...
                ApplicationSettings.Type.Marketing));
        ...
        apps.add(createSettings(
                ...
                emtpy, 
                "", 
                ApplicationSettings.Type.Payment));
        ...
        apps.add(createSettings(
                ...
                ApplicationSettings.Type.Webshop));
        ...
        apps.add(createSettings(
                ...
                ApplicationSettings.Type.Reporting));
        ...
        apps.add(createSettings(
                ...
                ApplicationSettings.Type.Shipment));
