		...
		for (String name : db.getCollectionNames()) {
			...
			while(cur.hasNext()) {
				...
				if (ob != null && ob.get("className") != null && ob.get("className").equals("com.thundashop.core.appmanager.data.Application")) {
					...
					List<String> defaultActivatedApps = Arrays.asList("Cleanish", "LeftMenu", "Product", "GoogleMaps", "OrderManager", "ContentManager", "YouTube", "Contact", "Logo", "Users", "GoogleAnalytics", "ImageDisplayer", "Footer", "Banner", "Search", "TopMenu");
