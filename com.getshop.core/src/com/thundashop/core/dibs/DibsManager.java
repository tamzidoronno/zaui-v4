...
public class DibsManager extends ManagerBase implements IDibsManager {
    ...
    public DibsManager(Logger log, DatabaseSaver databaseSaver) {
 ...
 *
     */
    public Map<String, String> captureTransaction(int amount, String merchantId, String transactionId, String macKeyHex) throws DecoderException {
     ...
     */
    public String calculateMac(Map<String, String> parameters, String macKeyHex) throws DecoderException {
        try {
    ...
    public void captureOrder(Order order, int amount) throws Exception {
        ...
        String secretMacKey = "474c334351374f2e6a2855447d4747576170596842355b232e2a3130424376464c4631787537404f75687257586833613273464042462968555642246c784763";
