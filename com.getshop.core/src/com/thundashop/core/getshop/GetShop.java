...
public class GetShop extends ManagerBase implements IGetShop {
    ...
    private void sendWelcomeEmailNorwegian(StartData startData, String newAddress) {
        ...
        emailTemplate += "            <br/> Vi i GetShop ønsker deg velkommen og vi skal gjøre vårt for at du blir fornøyd med din løsning. ";
        emailTemplate += "            <br/> ";
        ...
        emailTemplate += "            <br/> ";
        emailTemplate += "            <br/> Skriv ut denne eposten og lager den på et trygt sted, emailboksen bør ikke brukes som en lagringsplass for eposter.";
        emailTemplate += "            <br/> ";
        emailTemplate += "            <br/> <b>Trenger du hjelp til å komme i gang?</b>";
        emailTemplate += "            <br/> Slapp av, vi hjelper deg i gang og det koster deg ikke noe spesielt ekstra. Dette gjør vi for det er ikke så vanskelig som man skulle tro. Ta kontakt så gir vi deg noen hint om hvordan du kan komme i mål med ønskene dine.";
        emailTemplate += "            <br/> ";
        ...
        emailTemplate += "            <br/> Tlf: 940 10 704";
