...
public class APIArxManager {
     ...
     * @author boggi
     */
     public java.util.HashMap getLogForAllDoor(long start, long end)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          ...
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.HashMap<java.lang.String,java.util.List<com.thundashop.core.arx.AccessLog>>>() {}.getType();
