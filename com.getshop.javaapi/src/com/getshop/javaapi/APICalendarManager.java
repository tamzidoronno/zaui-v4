...
public class APICalendarManager {
     ...
     */
     public void addEvent(com.thundashop.core.calendarmanager.data.Event event)  throws Exception  {
     ...
     * has been attending to
     */
     public com.thundashop.core.calendarmanager.data.Event getEvent(java.lang.String eventId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("eventId",new Gson().toJson(eventId));
          ...
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<com.thundashop.core.calendarmanager.data.Event>() {}.getType();
          com.thundashop.core.calendarmanager.data.Event object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     * has been attending to
     */
     public java.util.List getEvents()  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          ...
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.List<com.thundashop.core.calendarmanager.data.Event>>() {}.getType();
          java.util.List object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     * has been attending to
     */
     public java.lang.String placeOrder(com.thundashop.core.calendarmanager.data.CalendarOrder order)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
