...
public class APICalendarManager {
     ...
     * @throws ErrorException
     */
     public void sendReminderToUser(boolean byEmail, boolean bySMS, java.util.List users, java.lang.String text, java.lang.String subject, java.lang.String eventId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
