...
public class APIHotelBookingManager {
     ...
     * @throws ErrorException
     */
     public com.thundashop.core.hotelbookingmanager.BookingReference getLastReservation(java.lang.String bodNr)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("bodNr",new Gson().toJson(bodNr));
     ...
     * @throws ErrorException
     */
     public boolean isAvilable(java.lang.String roomId, long start, long end)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("roomId",new Gson().toJson(roomId));
          data.args.put("start",new Gson().toJson(start));
          data.args.put("end",new Gson().toJson(end));
