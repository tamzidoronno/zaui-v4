...
public class APIHotelBookingManager {
     ...
     * @throws ErrorException
     */
     public java.lang.String completeOrder(java.lang.String userId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public java.lang.Integer extendStay(java.lang.Integer reference, long newdate, java.lang.String bdataid)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("reference",new Gson().toJson(reference));
          gs_json_object_data.args.put("newdate",new Gson().toJson(newdate));
          gs_json_object_data.args.put("bdataid",new Gson().toJson(bdataid));
          gs_json_object_data.method = "extendStay";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.lang.Integer>() {}.getType();
     ...
     * @throws ErrorException
     */
     public java.util.List getAllBookingsForUser()  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.method = "getAllBookingsForUser";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.List<com.thundashop.core.hotelbookingmanager.UsersBookingData>>() {}.getType();
     ...
     * @throws ErrorException
     */
     public java.util.List getAllCurrentUserBookingData()  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.method = "getAllCurrentUserBookingData";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.List<com.thundashop.core.hotelbookingmanager.UsersBookingData>>() {}.getType();
     ...
     * @throws ErrorException
     */
     public java.util.List getAllUsersInPeriode(long startDate, long endDate)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("startDate",new Gson().toJson(startDate));
          gs_json_object_data.args.put("endDate",new Gson().toJson(endDate));
          gs_json_object_data.method = "getAllUsersInPeriode";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.List<com.thundashop.core.hotelbookingmanager.UsersBookingData>>() {}.getType();
     ...
     * @throws ErrorException
     */
     public java.lang.String getCurrentRentalTermsContract()  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.method = "getCurrentRentalTermsContract";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.lang.String>() {}.getType();
     ...
     * @throws ErrorException
     */
     public java.util.List getInvoiceCustomers()  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.method = "getInvoiceCustomers";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
     ...
     * @throws ErrorException
     */
     public java.util.LinkedHashMap getStatistics(long startDate, long endDate, java.lang.String periodType)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("startDate",new Gson().toJson(startDate));
          gs_json_object_data.args.put("endDate",new Gson().toJson(endDate));
          gs_json_object_data.args.put("periodType",new Gson().toJson(periodType));
          gs_json_object_data.method = "getStatistics";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.LinkedHashMap<java.lang.String,com.thundashop.core.hotelbookingmanager.Statistics>>() {}.getType();
          java.util.LinkedHashMap object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     * @throws ErrorException
     */
     public com.thundashop.core.hotelbookingmanager.UsersBookingData getUserBookingDataByOrderId(java.lang.String orderId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("orderId",new Gson().toJson(orderId));
          gs_json_object_data.method = "getUserBookingDataByOrderId";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<com.thundashop.core.hotelbookingmanager.UsersBookingData>() {}.getType();
     ...
     * @throws ErrorException
     */
     public void markAsPayedForTest(java.lang.String userBookingDataId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("userBookingDataId",new Gson().toJson(userBookingDataId));
          gs_json_object_data.method = "markAsPayedForTest";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
     }
     ...
     * @throws ErrorException
     */
     public void removeRoomFromOrder(java.lang.Integer reference, java.lang.String room, java.lang.String bdata)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("reference",new Gson().toJson(reference));
          gs_json_object_data.args.put("room",new Gson().toJson(room));
          gs_json_object_data.args.put("bdata",new Gson().toJson(bdata));
          gs_json_object_data.method = "removeRoomFromOrder";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
     }
     ...
     * @throws ErrorException
     */
     public java.lang.Integer reserveRoom(long startDate, long endDate, java.lang.Integer count)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("startDate",new Gson().toJson(startDate));
          gs_json_object_data.args.put("endDate",new Gson().toJson(endDate));
     ...
     * @throws ErrorException
     */
     public java.lang.Integer reserveRoomAdvanced(long startDate, long endDate, java.lang.Integer count, com.thundashop.core.hotelbookingmanager.AdditionalBookingInformation additional, java.lang.String userBookingDataId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("startDate",new Gson().toJson(startDate));
          gs_json_object_data.args.put("endDate",new Gson().toJson(endDate));
          ...
          gs_json_object_data.args.put("additional",new Gson().toJson(additional));
          gs_json_object_data.args.put("userBookingDataId",new Gson().toJson(userBookingDataId));
          gs_json_object_data.method = "reserveRoomAdvanced";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.lang.Integer>() {}.getType();
     ...
     * @throws ErrorException
     */
     public void setVistorData(java.lang.String bdataId, java.util.HashMap visitors)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("bdataId",new Gson().toJson(bdataId));
     ...
     * @throws ErrorException
     */
     public com.thundashop.core.hotelbookingmanager.UsersBookingData startUserBookingData()  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.method = "startUserBookingData";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<com.thundashop.core.hotelbookingmanager.UsersBookingData>() {}.getType();
     ...
     * @throws ErrorException
     */
     public void toggleAvoidAutoDelete(java.lang.String bdataId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("bdataId",new Gson().toJson(bdataId));
          gs_json_object_data.method = "toggleAvoidAutoDelete";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
     }
     ...
     * @throws ErrorException
     */
     public void toggleForInvoice(java.lang.String userId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("userId",new Gson().toJson(userId));
          gs_json_object_data.method = "toggleForInvoice";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
     }
