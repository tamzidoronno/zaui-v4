...
public class APIHotelBookingManager {
     ...
     */
     public void appendOrderToReservation(java.lang.String orderId, int referenceId)  throws Exception  {
          ...
          gs_json_object_data.method = "appendOrderToReservation";
     ...
     * @throws ErrorException
     */
     public java.lang.String buildOrderForReservation(java.lang.Integer reservationNumber)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("reservationNumber",new Gson().toJson(reservationNumber));
          gs_json_object_data.method = "buildOrderForReservation";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
     ...
     * @throws ErrorException
     */
     public java.lang.String reserveRoom(java.lang.String roomType, long startDate, long endDate, java.util.List info, com.thundashop.core.hotelbookingmanager.AdditionalBookingInformation additionalInfo)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public void stopReservation(java.lang.Integer reservationNumber)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("reservationNumber",new Gson().toJson(reservationNumber));
          gs_json_object_data.method = "stopReservation";
          gs_json_object_data.interfaceName = "core.hotelbookingmanager.IHotelBookingManager";
          String result = transport.send(gs_json_object_data);
     }
