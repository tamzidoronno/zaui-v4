...
public class APIListManager {
     ...
     */
     public com.thundashop.core.listmanager.data.Entry addEntry(java.lang.String listId, com.thundashop.core.listmanager.data.Entry entry, java.lang.String parentPageId)  throws Exception  {
          ...
          Type typeJson_3323322222_autogenerated = new TypeToken<com.thundashop.core.listmanager.data.Entry>() {}.getType();
          com.thundashop.core.listmanager.data.Entry object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     */
     public void clearList(java.lang.String listId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("listId",new Gson().toJson(listId));
     ...
     * @throws ErrorException
     */
     public void combineList(java.lang.String toListId, java.lang.String newListId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     */
     public java.lang.String createListId()  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     */
     public void deleteEntry(java.lang.String id, java.lang.String listId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     * @return
     */
     public java.util.List getAllListsByType(java.lang.String type)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          ...
          String result = transport.send(data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.List<com.thundashop.core.listmanager.data.EntryList>>() {}.getType();
     ...
     * @throws ErrorException
     */
     public java.util.List getCombinedLists(java.lang.String listId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("listId",new Gson().toJson(listId));
     ...
     */
     public java.util.List getList(java.lang.String listId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("listId",new Gson().toJson(listId));
          data.method = "getList";
          ...
          String result = transport.send(data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.List<com.thundashop.core.listmanager.data.Entry>>() {}.getType();
          java.util.List object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     * @return
     */
     public com.thundashop.core.listmanager.data.Entry getListEntry(java.lang.String id)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("id",new Gson().toJson(id));
     ...
     */
     public java.util.List getLists()  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public java.lang.String getPageIdByName(java.lang.String name)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     */
     public com.thundashop.core.listmanager.data.Entry orderEntry(java.lang.String id, java.lang.String after, java.lang.String parentId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("id",new Gson().toJson(id));
     ...
     * @throws ErrorException
     */
     public void setEntries(java.lang.String listId, java.util.ArrayList entries)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("listId",new Gson().toJson(listId));
     ...
     * @throws ErrorException
     */
     public void unCombineList(java.lang.String fromListId, java.lang.String toRemoveId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     */
     public void updateEntry(com.thundashop.core.listmanager.data.Entry entry)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("entry",new Gson().toJson(entry));
