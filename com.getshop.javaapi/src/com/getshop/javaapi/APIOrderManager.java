...
public class APIOrderManager {
     ...
     */
     public void checkForRecurringPayments()  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public void setAllOrdersAsTransferedToAccountSystem()  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public void setExpiryDate(java.lang.String orderId, java.util.Date date)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("orderId",new Gson().toJson(orderId));
