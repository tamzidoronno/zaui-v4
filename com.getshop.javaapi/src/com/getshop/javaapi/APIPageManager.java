...
public class APIPageManager {
     ...
     */
     public com.thundashop.core.common.AppConfiguration addApplicationToRow(java.lang.String pageId, java.lang.String rowId, java.lang.String applicationSettingId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("pageId",new Gson().toJson(pageId));
          data.args.put("rowId",new Gson().toJson(rowId));
          data.args.put("applicationSettingId",new Gson().toJson(applicationSettingId));
