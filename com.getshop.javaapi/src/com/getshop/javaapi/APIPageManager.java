...
public class APIPageManager {
     ...
     */
     public com.thundashop.core.common.AppConfiguration addApplication(java.lang.String applicationSettingId, java.lang.String appAreaId)  throws Exception  {
     ...
     * @throws ErrorException
     */
     public void addLayoutCell(java.lang.String pageId, java.lang.String incell, java.lang.String aftercell)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("pageId",new Gson().toJson(pageId));
