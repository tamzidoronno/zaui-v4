...
public class APISedoxProductManager {
     ...
     * @throws ErrorException
     */
     public void addReference(java.lang.String productId, java.lang.String reference)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("productId",new Gson().toJson(productId));
     ...
     * @throws ErrorException
     */
     public com.thundashop.core.sedox.SedoxProduct createSedoxProduct(com.thundashop.core.sedox.SedoxProduct sedoxProduct, java.lang.String base64encodedOriginalFile, java.lang.String originalFileName, java.lang.String forSlaveId, java.lang.String origin)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public java.util.List getLatestProductsList(int count)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public java.lang.Double getPriceForProduct(java.lang.String productId, java.util.List files)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("productId",new Gson().toJson(productId));
     ...
     * @throws ErrorException
     */
     public java.util.List getProductIds()  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public java.util.List getStatistic()  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          ...
          String result = transport.send(data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.List<com.thundashop.core.sedox.SedoxProductStatistic>>() {}.getType();
          java.util.List object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     * @throws ErrorException
     */
     public void toggleBadCustomer(java.lang.String userId, boolean badCustomer)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("userId",new Gson().toJson(userId));
          data.args.put("badCustomer",new Gson().toJson(badCustomer));
     ...
     * @throws ErrorException
     */
     public void transferCreditToSlave(java.lang.String slaveId, double amount)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("slaveId",new Gson().toJson(slaveId));
          data.args.put("amount",new Gson().toJson(amount));
