...
public class APIStoreManager {
     ...
     */
     public java.lang.String getKey(java.lang.String key)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
     ...
     * @param secure Secure? Need to be administrator to read it?
     */
     public java.lang.String getKeySecure(java.lang.String key, java.lang.String password)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("key",new Gson().toJson(key));
          gs_json_object_data.args.put("password",new Gson().toJson(password));
     ...
     * @param secure Secure? Need to be administrator to read it?
     */
     public void removeKey(java.lang.String key)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("key",new Gson().toJson(key));
     ...
     * @param secure Secure? Need to be administrator to read it?
     */
     public void saveKey(java.lang.String key, java.lang.String value, boolean secure)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("key",new Gson().toJson(key));
