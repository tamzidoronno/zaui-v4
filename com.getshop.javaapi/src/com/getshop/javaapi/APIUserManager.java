...
public class APIUserManager {
     ...
     * @throws ErrorException
     */
     public java.util.Map cleanUpUsers(java.lang.String password)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          ...
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.Map<java.lang.String,java.lang.String>>() {}.getType();
     ...
     * @throws ErrorException
     */
     public boolean createAndSendNewPassword(java.lang.String emailAddress)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public com.thundashop.core.usermanager.data.User getUserByEmail(java.lang.String emailAddress)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          data.args.put("emailAddress",new Gson().toJson(emailAddress));
