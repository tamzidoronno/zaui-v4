...
public class APIUserManager {
     ...
     * @throws ErrorException
     */
     public void addGroupToUser(java.lang.String userId, java.lang.String groupId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("userId",new Gson().toJson(userId));
     ...
     * @throws ErrorException
     */
     public void deleteExtraAddressToGroup(java.lang.String groupId, java.lang.String addressId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("groupId",new Gson().toJson(groupId));
     ...
     * @throws ErrorException
     */
     public com.thundashop.core.usermanager.data.Group getGroup(java.lang.String groupId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("groupId",new Gson().toJson(groupId));
          ...
          String result = transport.send(gs_json_object_data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<com.thundashop.core.usermanager.data.Group>() {}.getType();
          com.thundashop.core.usermanager.data.Group object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     * @throws ErrorException
     */
     public java.util.List getUsersBasedOnGroupId(java.lang.String groupId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("groupId",new Gson().toJson(groupId));
     ...
     * @throws ErrorException
     */
     public void removeGroupFromUser(java.lang.String userId, java.lang.String groupId)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("userId",new Gson().toJson(userId));
          gs_json_object_data.args.put("groupId",new Gson().toJson(groupId));
     ...
     * @throws ErrorException
     */
     public void saveExtraAddressToGroup(com.thundashop.core.usermanager.data.Group group, com.thundashop.core.usermanager.data.Address address)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
     ...
     * @throws ErrorException
     */
     public com.thundashop.core.usermanager.data.Group saveGroup(com.thundashop.core.usermanager.data.Group group)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("group",new Gson().toJson(group));
     ...
     * @throws ErrorException
     */
     public java.util.List searchForGroup(java.lang.String searchCriteria)  throws Exception  {
          JsonObject2 gs_json_object_data = new JsonObject2();
          gs_json_object_data.args = new LinkedHashMap();
          gs_json_object_data.args.put("searchCriteria",new Gson().toJson(searchCriteria));
