...
public class APIUtilManager {
     ...
     * @author ktonder
     */
     public java.util.List getCompaniesFromBrReg(java.lang.String search)  throws Exception  {
          ...
          Type typeJson_3323322222_autogenerated = new TypeToken<java.util.List<com.thundashop.core.usermanager.data.Company>>() {}.getType();
     ...
     * @author ktonder
     */
     public com.thundashop.core.usermanager.data.Company getCompanyFree(java.lang.String companyVatNumber)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
