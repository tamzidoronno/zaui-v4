...
GetShopApiWebSocket.CartManager.prototype = {
    ...
    'addMetaDataToProduct' : function(productId,metaData, silent) {
        data = {
            args : {
                productId : JSON.stringify(productId),
...
GetShopApiWebSocket.HotelBookingManager.prototype = {
    'checkAvailable' : function(startDate,endDate,type,additional, silent) {
        data = {
            args : {
    ...
    'getAllReservationsArx' : function(silent) {
        data = {
            args : {
            },
            method: 'getAllReservationsArx',
            interfaceName: 'core.hotelbookingmanager.IHotelBookingManager',
        };
        return this.communication.send(data, silent);
    },
    ...
    'getRoomProductIds' : function(silent) {
        data = {
            args : {
            },
            method: 'getRoomProductIds',
            interfaceName: 'core.hotelbookingmanager.IHotelBookingManager',
        };
        return this.communication.send(data, silent);
    },

    'getUserIdForRoom' : function(roomNumber, silent) {
        data = {
            args : {
                roomNumber : JSON.stringify(roomNumber),
            },
            method: 'getUserIdForRoom',
            interfaceName: 'core.hotelbookingmanager.IHotelBookingManager',
        };
        return this.communication.send(data, silent);
    },
    ...
    'notifyUserAboutRoom' : function(reference,roomInfo,code, silent) {
        data = {
            args : {
                reference : JSON.stringify(reference),
    ...
    'reserveRoom' : function(roomType,startDate,endDate,info,additionalInfo, silent) {
        data = {
            args : {
...
GetShopApiWebSocket.OrderManager.prototype = {
    ...
    'getTotalSalesAmount' : function(year, silent) {
        data = {
            args : {
                year : JSON.stringify(year),
            },
