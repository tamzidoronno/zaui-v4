...
public class APIPageManager {
     ...
     */
     ...
     public HashMap getApplicationSettings(String name)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new HashMap();
     ...
     */
     ...
     public List getApplications()  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new HashMap();
     ...
     */
     ...
     public HashMap getPagesForApplications(List<String> appIds)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new HashMap();
     ...
     */
     ...
     public HashMap getSecuredSettings(String appName)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new HashMap();
          data.args.put("appName",new Gson().toJson(appName));
     ...
     */
     ...
     public HashMap translatePages(List<String> pages)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new HashMap();
