...
public class APIPageManager {
     ...
     */
     ...
     public List<Page> search(String search)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          ...
          String result = transport.send(data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<List<Page>>() {}.getType();
          List<Page> object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
