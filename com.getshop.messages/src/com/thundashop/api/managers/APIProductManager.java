...
public class APIProductManager {
     ...
     */
     ...
     public List getProducts(ProductCriteria productCriteria)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new HashMap();
     ...
     */
     ...
     public ArrayList getRandomProducts(Integer fetchSize, String ignoreProductId)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new HashMap();
          ...
          String result = transport.send(data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<ArrayList>() {}.getType();
          ArrayList object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     */
     ...
     public HashMap translateEntries(List<String> entryIds)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new HashMap();
          ...
          String result = transport.send(data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<HashMap>() {}.getType();
          HashMap object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
