...
public class APIProductManager {
     ...
     */
     ...
     public List<AttributeValue> getAllAttributes()  throws Exception  {
          ...
          String result = transport.send(data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<List<AttributeValue>>() {}.getType();
          List<AttributeValue> object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     */
     ...
     public String getPageIdByName(String productName)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
     ...
     */
     ...
     public List<TaxGroup> getTaxes()  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
          ...
          String result = transport.send(data);
          Gson gson = new GsonBuilder().serializeNulls().create();
          Type typeJson_3323322222_autogenerated = new TypeToken<List<TaxGroup>>() {}.getType();
          List<TaxGroup> object = gson.fromJson(result, typeJson_3323322222_autogenerated);
          return object;
     }
     ...
     */
     ...
     public void setTaxes(List<TaxGroup> group)  throws Exception  {
          JsonObject2 data = new JsonObject2();
          data.args = new LinkedHashMap();
