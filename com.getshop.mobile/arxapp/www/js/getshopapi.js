...
GetShopApiWebSocket = function(address, port) {
    this.sentMessages =  [];
...
GetShopApiWebSocket.BookingManager = function(communication) {
    this.communication = communication;
}

GetShopApiWebSocket.BookingManager.prototype = {
    'doTest' : function(testMe, silent) {
        data = {
            args : {
                testMe : JSON.stringify(testMe),
            },
            method: 'doTest',
            interfaceName: 'core.bookingengine.IBookingManager',
        };
        return this.communication.send(data, silent);
    },

    'saveData' : function(fullName, silent) {
        data = {
            args : {
...
GetShopApiWebSocket.HotelBookingManager.prototype = {
    'createDomain' : function(name,description, silent) {
        data = {
            args : {
    ...
    'createRoomType' : function(domainId,name,price,size, silent) {
        data = {
            args : {
...
GetShopApiWebSocket.prototype.createManagers = function() {
    ...
    this.BookingManager = new GetShopApiWebSocket.BookingManager(this);
