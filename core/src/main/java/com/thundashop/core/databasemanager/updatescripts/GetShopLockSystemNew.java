 ...
 */
@Component
public class GetShopLockSystemNew extends UpdateScriptBase implements UpdateScript {
    ...
    public static void main(String[] args) {
        new GetShopLockSystemNew().runSingle();
    }
    ...
    public void run() {
        ...
        GetShopLockSystem.moduleId = "apac";
        GetShopLockSystem.defaultActivate = true;
