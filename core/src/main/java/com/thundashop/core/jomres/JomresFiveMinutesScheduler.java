...
public class JomresFiveMinutesScheduler extends GetShopSchedulerBase {
    public JomresFiveMinutesScheduler(String webAddress, String username, String password, String scheduler, String multiLevelName) throws Exception {
