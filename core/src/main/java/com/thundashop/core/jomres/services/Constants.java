...
public class Constants {
    static String CHANNEL_ANNOUNCEMENT_URL = "cmf/channel/announce/";
    static String GET_PROPERTY_IDS_URL_THROUGH_CHANNEL = "cmf/properties/ids/";
    static String GET_PROPERTY_DETAILS_URL = "cmf/property/";
