 ...
 * @author boggi
 */
public class CheckPmsFiveMin extends GetShopSchedulerBase {

    public CheckPmsFiveMin(String webAddress, String username, String password, String scheduler, String multiLevelName) throws Exception {
