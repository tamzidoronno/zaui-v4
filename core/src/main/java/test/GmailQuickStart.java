...
//        InputStream in = GmailQuickStart.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        File file = new File("../gmailcredentials.json");
    ...
    public static void doFolder(Gmail.Users.Messages messages, String q, Gmail service) throws IOException {
        Gmail.Users.Messages.List request = messages.list("me");
        request.setQ("in:INBOX/Behandlet,  newer_than:2d");
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException, InterruptedException {
        ...
        doFolder(messages, "in:inbox/behandlet newer_than:2d", service);
        doFolder(messages, "in:inbox newer_than:2d", service);
