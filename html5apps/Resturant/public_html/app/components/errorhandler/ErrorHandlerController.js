...
controllers.ErrorHandlerController = function($scope, $rootScope, $state, datarepository, $api) {
    ...
    $scope.reportError = function() {
        $api.getApi().MessageManager.sendMail('post@getshop.com', 'GetShop Support', 'Resturant application error', $scope.message, 'post@getshop.com', 'GetShop Support').done($scope.errorReported);
    }
