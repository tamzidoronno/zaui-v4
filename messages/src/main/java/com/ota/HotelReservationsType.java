...
public class HotelReservationsType {
    ...
    public List<HotelReservationsType.HotelReservation> getHotelReservation() {
        if (hotelReservation == null) {
            hotelReservation = new ArrayList<>();
        }
        return this.hotelReservation;
    }

    public void setHotelReservation(List<HotelReservationsType.HotelReservation> reservations) {
        this.hotelReservation = reservations;
    }
