...
public enum GoToStatusCodes {
        ...
        ACTIVITY_GOTO_PAYMENT(1408, "Goto Booking Confirmation Failed.. " +
                "Reason: GOTO_PAYMENT method is not allowed for booking with activities"),
