...
cat << EOF > batcbackend
put /home/naxa/builds/3300/archive/artifacts/builds/3.0.0/backend_3.0.0.tar.gz
EOF
...
#PHP CODE
cat << EOF > batchfile
put "/home/naxa/builds/3300/archive/artifacts/builds/3.0.0/php_3.0.0.tar.gz"
EOF
