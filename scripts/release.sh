...
if [ $releaseAnswer = "1" ]; then
	...
	if [ $serverQuestion = "3" ]; then
		...
		ssh naxa@jenkins.getshop.com '/home/naxa/scripts/releaseSoftware.sh 10.0.4.33 10.0.4.32'
	elif [ $serverQuestion = "5" ]; then
		ssh naxa@jenkins.getshop.com '/home/naxa/scripts/releaseSoftware.sh 10.0.5.33 10.0.5.32'
        elif [ $serverQuestion = "6" ]; then
                ssh naxa@jenkins.getshop.com '/home/naxa/scripts/releaseSoftware.sh 10.0.6.33 10.0.6.32'
        elif [ $serverQuestion = "9" ]; then
                ssh naxa@jenkins.getshop.com '/home/naxa/scripts/releaseSoftware.sh 10.0.9.33 10.0.9.32'
	else 
